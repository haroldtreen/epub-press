...
class ContentExtractor {
    ...
    static preprocess(html) {
        return new Promise((resolve) => {
            const operations = {
                removeElement: ['link,script,iframe,.hidden,.visually-hidden,.clear'],
                replaceWithChildren: ['noscript', 'figure'],
                filterDivs: ['popup', 'signup', 'hidden', 'addthis'],
                replaceDivsWithChildren: ['frame', 'wrapper', 'content-wrapper', 'supplemental'],
            };
