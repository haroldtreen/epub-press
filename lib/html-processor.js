...
class HtmlProcessor {
    ...
    */
    ...
    static propagateDirProperty(selector, html) {
        return HtmlProcessor._proccessElements(selector, html, ($elem, _) => {
            if ($elem.attr('dir') === 'rtl') {
                $elem.find('p').each((i, elem) => {
                    elem.attribs.dir = 'rtl';
                });
            }
        });
    }
